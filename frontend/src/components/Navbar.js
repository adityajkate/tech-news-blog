...
const Navbar = () => {
  ...
  return (
    <nav 
      className={`fixed top-0 w-full z-50 py-4 transition-all duration-200 ${
        scrolled
          ? 'bg-light-surface dark:bg-dark-surface shadow-sm border-b border-light-border dark:border-dark-border'
